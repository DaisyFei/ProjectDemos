    ...
    display_element.append($('<button>', {
      ...
      "click": function() {
        ...
        $('.jspsych-free-sort-draggable').each(function() {
          if(parseInt($(this).css('top'),10)>150 && parseInt($(this).css('top'),10)<400) {
            console.log("these are the coords " + parseInt($(this).css('top'),10));
            if(parseInt($(this).css('left'),10)>0 && parseInt($(this).css('left'),10)<300) {
              leftPerson+=1;
            }
            // if($(this).css('left')>400 && $(this).css('left')<800) {
            else if(parseInt($(this).css('left'),10)>400 && parseInt($(this).css('left'),10)<800) {
              rightPerson+=1;
            }
          } else {
            console.log("these are the coords " + parseInt($(this).css('top'),10));
...
//        }
        var trial_data = {
          ...
          "leftNum":leftPerson,
          "rightNum": rightPerson,
          "left":trial.labels[0],
          "right":trial.labels[1],  
